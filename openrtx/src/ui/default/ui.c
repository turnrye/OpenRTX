    ...
    if(event.type == EVENT_KBD)
    {
        ...
        switch(state.ui_screen)
        {
            ...
            case MESSAGES_LIST:
            {
                ...
                if(idx < count)
                {
                    message_header_t *sel_hdr = messages_get(idx);
                    ui_state.messages_list_seq =
            ...
            case MESSAGES_DETAIL:
            {
                ...
                if(msg.keys & KEY_UP || msg.keys & KNOB_LEFT)
                {
                    ...
                    else if (idx > 0)
                    {
                        ...
                        message_header_t *prev = messages_get(idx - 1);
                        if (prev != NULL)
                        {
                ...
                else if(msg.keys & KEY_DOWN || msg.keys & KNOB_RIGHT)
                {
                    ...
                    else if (idx + 1 < messages_count())
                    {
                        ...
                        message_header_t *next = messages_get(idx + 1);
                        if (next != NULL)
                        {
                ...
                else if(msg.keys & KEY_ENTER)
                {
                           ...
                           MSG_ACTION_REPLY))
                    {
                        ...
                        message_header_t *reply_hdr = messages_get(idx);
                        _ui_startCompose(
