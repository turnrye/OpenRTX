...
/**
 * \internal
 * Remove an entry, keeping the remaining entries in order.
 *
 ...
 */
static bool poolInUse(uint16_t start, uint16_t end)
{
 ...
 * older body may survive at the end of the pool: evicting in table order
