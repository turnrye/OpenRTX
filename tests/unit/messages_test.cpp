          ...
          "[messages][registry]")
{
    ...
    MessageSource entries[] = { { &fake_ops, &src } };
    ...
    "[messages][registry]")
{
    ...
    MessageSource entries[] = { { &restricted_ops, &src } };
    MessageRegistry reg(entries, 1);
    reg.tick();
    REQUIRE(reg.count() == 1);
          ...
          "[messages][registry]")
{
    ...
    MessageSource entries[] = { { &big_ops, &bigSrc } };
    MessageRegistry reg(entries, 1);
          ...
          "[messages][registry]")
{
    ...
    MessageSource entries[] = { { &sparse_ops, nullptr } };
    MessageRegistry reg(entries, 1);
    reg.tick();
    ...
    "[messages][registry]")
{
    ...
    MessageSource entries[] = { { &null_invoke_ops, &src } };
    MessageRegistry reg(entries, 1);
    reg.tick();
    REQUIRE(reg.count() == 1);
          ...
          "[messages][registry]")
{
    ...
    MessageSource entries[] = { { &ops_changing, &src } };
          ...
          "[messages][registry]")
{
    ...
    MessageSource entries[] = { { &ops_send, &src } };
    MessageRegistry reg(entries, 1);
