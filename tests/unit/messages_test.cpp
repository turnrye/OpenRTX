          ...
          "[messages][registry]")
{
    ...
    /*
     * Simulate deletion: the fake vtable's invoke_action() is a no-op on
          ...
          "[messages][registry]")
{
    ...
    message_header_t *ptr0 = reg.get(0);
    message_header_t *ptr1 = reg.get(1);
...
TEST_CASE("MessageRegistry: a source's tick() return value drives rebuild",
          "[messages][registry]")
{
    static const message_type_vtable_t vtable_changing = {
        /* name              */ "Changing",
        /* count             */ fake_count,
        /* get               */ fake_get,
        /* supported_actions */ fake_supported_actions,
    ...
    SourceEntry entries[] = { { &vtable_changing, &src } };
...
TEST_CASE("MessageRegistry: send marks dirty only on success",
          "[messages][registry]")
{
    static const message_type_vtable_t vtable_send = {
        /* name              */ "Sendable",
        /* count             */ fake_count,
        /* get               */ fake_get,
        /* supported_actions */ nullptr,
    ...
    SourceEntry entries[] = { { &vtable_send, &src } };
    reg.init(entries, 1);
