...
typedef struct {
    // Byte 0
    uint8_t channel_mode : 2, bandwidth : 2, autoscan : 1, _unused1 : 2,
        lone_worker : 1;

    // Byte 1
    uint8_t _unused2 : 1, rx_only : 1, repeater_slot : 2, colorcode : 4;
    ...
    // Byte 3
    uint8_t rx_ref_frequency : 2, _unused3 : 1, emergency_alarm_ack : 1,
        _unused4 : 3, display_pttid_dis : 1;

    // Byte 4
    uint8_t tx_ref_frequency : 2, _unused5 : 2, vox : 1, _unused6 : 1,
        admit_criteria : 2;

    // Byte 5
    uint8_t _unused7 : 4, in_call_criteria : 2, turn_off_freq : 2;
    ...
    // Byte 30
    uint8_t power : 2, _unused10 : 6;

    // Byte 31
    uint8_t _unused11 : 3, dcdm_switch_dis : 1, leader_ms : 1, _unused12 : 3;
