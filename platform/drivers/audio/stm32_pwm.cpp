...
using Dma1_Stream2 =
    DmaStream<DMA1_BASE, 2, 1,
              3>; // DMA 1, Stream 2, channel 1, very high priority

static const struct PwmChannelCfg *config; // Config
static struct streamCtx *context; // Current stream context
static StreamHandler stream(Dma1_Stream2::init(10, DataSize::_16BIT,
                                               1)); // DMA stream handler
...
const struct audioDriver stm32_pwm_audio_driver = { .start = stm32pwm_start,
