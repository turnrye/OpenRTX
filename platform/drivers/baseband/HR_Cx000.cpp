...
template <> void HR_Cx000<C5000_SpiOpModes>::setDacGain(int8_t gain)
{
    // TODO: "DALin" register for HR_C5000 is not documented.
    (void)gain;
}

template <> void HR_Cx000<C6000_SpiOpModes>::setDacGain(int8_t gain)
{
...
template <> void HR_Cx000<C5000_SpiOpModes>::setInputGain(int8_t value)
{
    /*
...
template <> void HR_Cx000<C6000_SpiOpModes>::setInputGain(int8_t value)
{
    /*
