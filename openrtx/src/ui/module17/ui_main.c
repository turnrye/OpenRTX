...
static void _ui_drawModeInfo(ui_state_t *ui_state)
{
    switch (last_state.channel.mode) {
        case OPMODE_M17: {
            ...
            if (rtxStatus.lsfOk) {
                gfx_drawSymbol(layout.line2_pos, layout.line2_symbol_font,
                ...
                gfx_print(layout.line2_pos, layout.line2_font,
                          ...
                          rtxStatus.M17_dst);
                gfx_drawSymbol(layout.line1_pos, layout.line1_symbol_font,
                ...
                if (rtxStatus.M17_link[0] != '\0') {
                    gfx_drawSymbol(layout.line4_pos, layout.line3_symbol_font,
                                   TEXT_ALIGN_LEFT, color_white,
                                   SYMBOL_ACCESS_POINT);
                ...
                if (rtxStatus.M17_refl[0] != '\0') {
                    gfx_drawSymbol(layout.line3_pos, layout.line4_symbol_font,
                                   TEXT_ALIGN_LEFT, color_white,
                                   SYMBOL_NETWORK);
                ...
                gfx_print(layout.line2_pos, layout.line2_font,
                          TEXT_ALIGN_CENTER, color_white, last);
                // Print M17 Destination ID on line 2
                gfx_print(layout.line3_pos, layout.line3_font,
                          TEXT_ALIGN_CENTER, color_white, "%s", dst);
                if (ui_state->edit_mode) {
                    // Print Button Info
                    gfx_print(layout.line5_pos, layout.line5_font,
                              TEXT_ALIGN_LEFT, color_white, "Cancel");
                    gfx_print(layout.line5_pos, layout.line5_font,
                              TEXT_ALIGN_RIGHT, color_white, "Accept");
                } else {
                    // Menu
                    gfx_print(layout.line5_pos, layout.line5_font,
                              TEXT_ALIGN_RIGHT, color_white, "Menu");
                }
                break;
            }
        }
