...
static const struct gpio_dt_spec pmu_irq =
    GPIO_DT_SPEC_GET(PMU_IRQ_NODE, gpios);
...
static int pmu_registerWriteByte(uint8_t devAddr, uint8_t regAddr,
...
void pmu_init()
{
    ...
    const uint32_t i2c_cfg = I2C_SPEED_SET(I2C_SPEED_FAST) |
                             I2C_MODE_CONTROLLER;
    ...
    * */
    ...
    PMU.enableIRQ(XPOWERS_AXP2101_BAT_INSERT_IRQ |
                  ...
                  XPOWERS_AXP2101_PKEY_NEGATIVE_IRQ | // POWER KEY ON/OFF
    ...
    static const uint16_t currTable[] = { 0,   0,   0,   0,   100, 125,
    ...
    static const uint16_t tableVoltage[] = { 0,    4000, 4100, 4200,
                                             4350, 4400, 255 };
