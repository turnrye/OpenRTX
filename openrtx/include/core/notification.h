...
static inline const char *notification_type_name(enum notification_type type)
{
    (void)type;
    return "";
}

static inline const char *msg_notification_tone_name(uint8_t idx)
{
    (void)idx;
    return "";
}

static inline void notification_play_message_tone(enum notification_type type,
                                                  uint8_t tone_idx)
{
    (void)type;
    (void)tone_idx;
...
static inline void notification_play_tone_preview(uint8_t tone_idx)
{
    (void)tone_idx;
}

static inline bool notification_toneActive(void)
{
    return false;
}

static inline void notification_tick(void)
{
}
