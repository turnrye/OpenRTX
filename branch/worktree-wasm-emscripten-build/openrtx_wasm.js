...
function findWasmBinary() {
  return locateFile("openrtx_wasm.wasm");
}
...
var fillFullscreenChangeEventData = eventStruct => {
  ...
  (growMemViews(), HEAP32)[(((eventStruct) + (260)) >> 2)] = reportedElement?.clientWidth ?? 0;
  (growMemViews(), HEAP32)[(((eventStruct) + (264)) >> 2)] = reportedElement?.clientHeight ?? 0;
...
var ASM_CONSTS = {
  ...
  187450: () => window.innerWidth,
  187480: () => window.innerHeight
};

// Imports from the Wasm binary.
var _emulator_command = Module["_emulator_command"] = makeInvalidEarlyAccess("_emulator_command");
