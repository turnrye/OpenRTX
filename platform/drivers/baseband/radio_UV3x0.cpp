...
HR_C6000 C6000((const struct spiDevice *)&c6000_spi,
               { DMR_CS }); // HR_C6000 driver
...
void radio_updateConfiguration()
{
    ...
    if (currRxBand == BND_UHF)
        rxModBias = calData.uhfCal.freqAdjustMid;
    if (currTxBand == BND_UHF)
        txModBias = calData.uhfCal.freqAdjustMid;
