...
void printCalibration_gdx()
{
    ...
    printf("\r\ntxHighPower:       ");
    for (i = 0; i < 16; i++)
        printf("%03d ", cal.data[1].txHighPower[i]);
    printf("\r\ntxLowPower:        ");
    for (i = 0; i < 16; i++)
        printf("%03d ", cal.data[1].txLowPower[i]);
    printf("\r\nanalogSqlThresh:   ");
    for (i = 0; i < 8; i++)
        printf("%03d ", cal.data[1].analogSqlThresh[i]);
    ...
    printf("\r\nmod1Amplitude:     ");
    for (i = 0; i < 8; i++)
        printf("%03d ", cal.data[1].mod1Amplitude[i]);
    ...
    printf("\r\nuhfPwrCalPoints:   ");
    for (i = 0; i < 16; i++)
        printf("%ld ", cal.uhfPwrCalPoints[i]);
    printf("\r\nuhfCalPoints:      ");
    for (i = 0; i < 8; i++)
        printf("%ld ", cal.uhfCalPoints[i]);
    ...
    printf("\r\ntxHighPower:       ");
    for (i = 0; i < 8; i++)
        printf("%03d ", cal.data[0].txHighPower[i]);
    printf("\r\ntxLowPower:        ");
    for (i = 0; i < 8; i++)
        printf("%03d ", cal.data[0].txLowPower[i]);
    printf("\r\nanalogSqlThresh:   ");
    for (i = 0; i < 8; i++)
        printf("%03d ", cal.data[0].analogSqlThresh[i]);
    ...
    printf("\r\nmod1Amplitude:     ");
    for (i = 0; i < 8; i++)
        printf("%03d ", cal.data[0].mod1Amplitude[i]);
...
void printCalibration_md3x0()
{
    ...
    nvm_read(2, -1, 0x0000, rawData + 256,
             256); // W25Qx security register 0x0100
    ...
    printf("\r\ntxHighPower:        ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.txHighPower[i]);
    printf("\r\ntxLowPower:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.txLowPower[i]);
    printf("\r\nrxSensitivity:      ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.rxSensitivity[i]);
    printf("\r\nopenSql9:           ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.openSql9[i]);
    printf("\r\ncloseSql9:          ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.closeSql9[i]);
    printf("\r\nopenSql1:           ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.openSql1[i]);
    printf("\r\ncloseSql1:          ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.closeSql1[i]);
    printf("\r\nmaxVolume:          ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.maxVolume[i]);
    printf("\r\nctcss67Hz:          ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.ctcss67Hz[i]);
    printf("\r\nctcss151Hz:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.ctcss151Hz[i]);
    printf("\r\nctcss254Hz:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.ctcss254Hz[i]);
    printf("\r\ndcsMod2:            ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.dcsMod2[i]);
    printf("\r\ndcsMod1:            ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.dcsMod1[i]);
    printf("\r\nmod1Partial:        ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.mod1Partial[i]);
    printf("\r\nanalogVoiceAdjust:  ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.analogVoiceAdjust[i]);
    printf("\r\nlockVoltagePartial: ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.lockVoltagePartial[i]);
    printf("\r\nsendIpartial:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.sendIpartial[i]);
    printf("\r\nsendQpartial:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.sendQpartial[i]);
    printf("\r\nsendIrange:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.sendIrange[i]);
    printf("\r\nsendQrange:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.sendQrange[i]);
    printf("\r\nrxIpartial:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.rxIpartial[i]);
    printf("\r\nrxQpartial:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.rxQpartial[i]);
    printf("\r\nanalogSendIrange:   ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.analogSendIrange[i]);
    printf("\r\nanalogSendQrange:   ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.analogSendQrange[i]);

    printf("\r\n\r\nrxFreq: ");
    for (i = 0; i < 9; i++)
        printf("%ld ", bcdToBin(cal.freq[2 * i]) * 10);
    printf("\r\ntxFreq:     ");
    for (i = 0; i < 9; i++)
        printf("%ld ", bcdToBin(cal.freq[2 * i + 1]) * 10);
}
...
void printCalibration_mduv3x0()
{
    ...
    printf("\r\ntxHighPower:      ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_txHighPower[i]);
    printf("\r\ntxMidPower:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_txMidPower[i]);
    printf("\r\ntxLowPower:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_txLowPower[i]);
    printf("\r\nrxSensitivity:    ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_rxSensitivity[i]);
    printf("\r\nopenSql9:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_openSql9[i]);
    printf("\r\ncloseSql9:        ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_closeSql9[i]);
    printf("\r\nopenSql1:         ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_openSql1[i]);
    printf("\r\ncloseSql1:        ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_closeSql1[i]);
    printf("\r\nctcss67Hz:        ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_ctcss67Hz[i]);
    printf("\r\nctcss151Hz:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_ctcss151Hz[i]);
    printf("\r\nctcss254Hz:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_ctcss254Hz[i]);
    printf("\r\ndcsMod1:          ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_dcsMod1[i]);
    printf("\r\nsendIrange:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_sendIrange[i]);
    printf("\r\nsendQrange:       ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_sendQrange[i]);
    printf("\r\nanalogSendIrange: ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_analogSendIrange[i]);
    printf("\r\nanalogSendQrange: ");
    for (i = 0; i < 9; i++)
        printf("%03d ", cal.uhf_analogSendQrange[i]);
    printf("\r\nrxFreq:           ");
    for (i = 0; i < 9; i++)
        printf("%ld ", bcdToBin(cal.uhf_freq[2 * i]) * 10);
    printf("\r\ntxFreq:           ");
    for (i = 0; i < 9; i++)
        printf("%ld ", bcdToBin(cal.uhf_freq[2 * i + 1]) * 10);

    puts("\r\nVHF band:\r");
    printf("freqAdjustMid:        %03d\r\n", cal.vhf_freqAdjustMid);
    printf("\r\ntxHighPower:      ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_txHighPower[i]);
    printf("\r\ntxMidPower:       ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_txMidPower[i]);
    printf("\r\ntxLowPower:       ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_txLowPower[i]);
    printf("\r\nrxSensitivity:    ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_rxSensitivity[i]);
    printf("\r\nopenSql9:         ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_openSql9[i]);
    printf("\r\ncloseSql9:        ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_closeSql9[i]);
    printf("\r\nopenSql1:         ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_openSql1[i]);
    printf("\r\ncloseSql1:        ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_closeSql1[i]);
    printf("\r\nctcss67Hz:        ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_ctcss67Hz[i]);
    printf("\r\nctcss151Hz:       ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_ctcss151Hz[i]);
    printf("\r\nctcss254Hz:       ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_ctcss254Hz[i]);
    printf("\r\ndcsMod1:          ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_dcsMod1[i]);
    printf("\r\nsendIrange:       ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_sendIrange[i]);
    printf("\r\nsendQrange:       ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_sendQrange[i]);
    printf("\r\nanalogSendIrange: ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_analogSendIrange[i]);
    printf("\r\nanalogSendQrange: ");
    for (i = 0; i < 5; i++)
        printf("%03d ", cal.vhf_analogSendQrange[i]);
    printf("\r\nrxFreq:           ");
    for (i = 0; i < 5; i++)
        printf("%ld ", bcdToBin(cal.vhf_freq[2 * i]) * 10);
    printf("\r\ntxFreq:           ");
    for (i = 0; i < 5; i++)
        printf("%ld ", bcdToBin(cal.vhf_freq[2 * i + 1]) * 10);
}
